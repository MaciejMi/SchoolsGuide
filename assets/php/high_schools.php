...
$query_str = "SELECT * FROM schools WHERE schools.type = 0 ORDER BY (schools.polish_avg + schools.polish_rate + schools.eng_avg + schools.eng_rate + schools.math_avg + schools.math_rate + schools.google_stars) / 7 DESC ;";
...
<body>
    <nav class='nav'>
        <div class="wrapper">
            <div class="nav--header">
                <a href="../../index.html#home" class="nav--title"> <img src="../img/logo.png"
                        alt="Zdjęcie przedstawia czerwone logo">
    ...
    <header class="header header--small" id="home" style="height: 40vh;">
    ...
    <section class="section ranking" id="ranking">
        <div class="text-box">
            <h2 class="heading">Ranking Liceów</h2>
